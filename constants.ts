...
Line 4: (Worried, Frantic) "With the entrance of this repulsive and unplanned guest… I’ve lost control of my illusions!" -Chapter 20`,
  },
  {
    ...
    auditionLines: `Line 1: (In thought) "Sending your illusions through the Port Oak to
evade us... you've always been clever, Drendith." -Chapter 16
...
Line 4: (Furious, Exploding) "Grrr...Then fuck formalities!! Let me speak freely, Ender!!" -Chapter 16`,
  },
  {
    ...
    auditionLines: `Line 1: (Gentle yet bossy) "Kaz Greenfield! You will now be ticketed for reciting mission codes! You know better!" -Chapter 4

Line 2: (Excited, cheering tone) "So fight your hearts out! Show them what the great defenders of Glory Peak can do!" -Chapter 5

Line 3: (Sarcastic) "Rou Akei, you're getting one too. For not checking in at the front desk." -Chapter 4

Line 4: (Heavy, somber) "Yes... Altamerian. The place our entire country has tried to put behind us." -Chapter 4

OPTIONAL: (Shocked) "Oh my goodness!! How has he managed to infiltrate us?!" -Chapter 5 `,
  },
];
